package com.nine.palace.headpic;
...
public class NinePalaceImageView<T> extends ViewGroup {
    ...
    private NinePalaceImageViewAdapter<T> mAdapter;

    public NinePalaceImageView(Context context) {
        super(context, null);
    }

    public NinePalaceImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NinePalaceImageView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.NinePalaceImageView);
        this.mGap = (int) typedArray.getDimension(R.styleable.NinePalaceImageView_imgGap, 8);
        typedArray.recycle();
    }
     ...
     * @param adapter 适配器
     */
    public void setAdapter(NinePalaceImageViewAdapter adapter) {
        mAdapter = adapter;
    }
